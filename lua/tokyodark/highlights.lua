...
M.highlights = {
    ...
    IncSearch = { fg = p.bg0, bg = p.violet },
    ...
    StatusLine = { fg = p.fg, bg = p.none },
    StatusLineTerm = { fg = p.fg, bg = p.bg2 },
    StatusLineNC = { fg = p.grey, bg = p.none },
    ...
    PreCondit = { fg = p.pink },
    Include = { fg = p.pink },
    Keyword = { fg = p.pink } + styles.keywords,
    Define = { fg = p.pink },
    Typedef = { fg = p.pink },
    Exception = { fg = p.pink },
	...
	TelescopeBorder = { fg = p.violet },
	TelescopeTitle = { fg = p.orange },

    NvimTreeOpenedFile = { bg = p.bg2 },
	NvimTreeIndentMarker = { fg = p.grey },

	--NvimTreeGitNewIcon = {fg = p.fg },
	--NvimTreeGitDirtyIcon = {fg = p.fg },
	--NvimTreeGitMergeIcon = {fg = p.fg },
	--NvimTreeGitStagedIcon = {fg = p.fg },
	--NvimTreeGitDeletedIcon = {fg = p.fg },
	--NvimTreeGitRenamedIcon = {fg = p.fg },
	--NvimTreeGitIgnoredIcon = {fg = p.fg },
	NvimTreeGitFileNewHL = {fg = p.green },
	NvimTreeGitFileDirtyHL = {fg = p.purple },
	NvimTreeGitFileMergeHL = {fg = p.yellow },
	NvimTreeGitFileStagedHL = {fg = p.orange },
	NvimTreeGitFileDeletedHL = {fg = p.red },
	NvimTreeGitFileIgnoredHL = {fg = p.grey },
	NvimTreeGitFileRenamedHL = {fg = p.blue },
	NvimTreeGitFolderNewHL = {fg = p.green },
	NvimTreeGitFolderDirtyHL = {fg = p.purple },
	NvimTreeGitFolderMergeHL = {fg = p.yellow },
	NvimTreeGitFolderStagedHL = {fg = p.orange },
	NvimTreeGitFolderDeletedHL = {fg = p.red },
	NvimTreeGitFolderIgnoredHL = {fg = p.grey },
	NvimTreeGitFolderRenamedHL = {fg = p.blue },


    -- whichkey
    WhichKey = { fg = p.green },
    WhichKeyDesc = { fg = p.purple },
    WhichKeyGroup = { fg = p.orange },
    WhichKeySeparator = { fg = p.bg3 },
    ...
    LspDiagnosticsDefaultHint = { fg = p.cyan },
    LspDiagnosticsDefaultInformation = { fg = p.violet },
    ...
    DiagnosticError = { fg = p.red + gamma(0.5) },
    DiagnosticSignHint = { fg = p.cyan },
    DiagnosticHint = { fg = p.cyan },
    DiagnosticSignInfo = { fg = p.violet },
    DiagnosticInfo = { fg = p.violet },
